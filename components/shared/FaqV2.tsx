    ...
    <section className="pb-14 pt-14 md:pb-16 md:pt-16 lg:pb-[88px] lg:pt-[88px] xl:pb-[100px] xl:pt-[100px]">
      <div className="container">
        ...
        <div className="mx-auto grid w-full grid-cols-1 items-start gap-7 md:grid-cols-2 lg:grid-cols-3">
          <RevealWrapper className="space-y-[25px] md:space-y-[30px]">
            {faqData?.map((faq, i) => (
              <div className="reveal-me" key={i}>
                <div
                  ...
                  <div
                    ...
                    <div
                      className={`accordion-header-iconV4 transition-transform duration-[400ms] dark:border-dark ${activeAccordion === faq?.question ? 'open active rotate-180' : ''}`}
                    />
                  </div>
                  <div
                    className={`grid transition-all duration-[400ms] ease-in-out ${activeAccordion === faq?.question ? 'grid-rows-[1fr]' : 'grid-rows-[0fr]'}`}>
