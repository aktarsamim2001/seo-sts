...
const BlogContent = ({ blog_content, blogList, image }: any) => {
  ...
  // const fallbackHeadings = blog_content?.content?.match(/^###?\s(.+)/gm) || []
  // const autoGeneratedTOC = fallbackHeadings.map((heading: string) => {
  ...
  //   blog_content?.table_contents?.length > 0
  //     ? blog_content.table_contents.map((item: any) => ({
  //         title: item.title,
    ...
    <section className="pb-14 md:pb-16 lg:pb-[88px] xl:pb-[100px]">
      <div className="mx-auto max-w-[1440px] px-6 md:px-10 lg:px-20">
        <RevealWrapper as="figure" className="reveal-me w-full 2xl:max-h-[523px]">
          {image && <Image src={image} width={1280} height={523} alt="Blog Details" className="w-full object-cover" />}
        </RevealWrapper>
