      ...
      <div className="container">
        ...
        <article>
          ...
          <RevealWrapper className="mb-[30px] flex flex-col gap-[30px] max-lg:flex-wrap md:flex-row">
            {/* First 3 cards */}
            <RevealWrapper className="flex-1 border border-[#F54BB4] px-[30px] py-20 dark:border-[#F54BB4] dark:border-dark">
              <span>
              ...
              <h5 className="mb-2.5 mt-5 lg:text-[35px]">Illustration & Custom Graphics</h5>
            ...
            <RevealWrapper className="flex-1 border border-[#F54BB4] px-[30px] py-20 dark:border-[#F54BB4] dark:border-dark">
              ...
              <h5 className="mb-2.5 mt-5 lg:text-[35px]">Packaging & Print Design</h5>
            ...
            <RevealWrapper className="flex-1 border border-[#F54BB4] px-[30px] py-20 dark:border-[#F54BB4] dark:border-dark">
              ...
              <h5 className="mb-2.5 mt-5 lg:text-[35px]">Photo & Image Production</h5>
              <p className="text-base leading-[1.6]">Apps built for growth, high performance &amp; security.y</p>
            </RevealWrapper>
          </RevealWrapper>
          {/* 2nd row: 2 columns */}
          <RevealWrapper className="mb-[30px] flex flex-col gap-[30px] md:flex-row">
            {/* Next 2 cards */}
            <RevealWrapper className="min-h-[322px] flex-1 border border-[#F54BB4] px-[30px] py-20 dark:border-[#F54BB4] dark:border-dark">
              <span>
                <svg xmlns="http://www.w3.org/2000/svg" width={60} height={60} viewBox="0 0 60 60" fill="none">
                  <rect width={60} height={60} className="fill-backgroundBody dark:fill-secondary" />
                  <path
              ...
              <h5 className="mb-2.5 mt-5 lg:text-[35px]">Video & Motion Services</h5>
            ...
            <RevealWrapper className="min-h-[322px] flex-1 border border-[#F54BB4] px-[30px] py-20 dark:border-[#F54BB4] dark:border-dark">
              ...
              <h5 className="mb-2.5 mt-5 lg:text-[35px]">Web & Digital Design</h5>
              <p className="text-base leading-[1.6]">Web, iOS, and Android compatibility.</p>
            </RevealWrapper>
          </RevealWrapper>
          {/* 3rd row: 4 columns (add new row for remaining cards) */}
          <RevealWrapper className="flex flex-col gap-[30px] md:flex-row">
            {/* Add 4 more cards here, copying the RevealWrapper structure and content, updating the title/description/icon as needed */}
            <RevealWrapper className="flex-1 border border-[#F54BB4] px-[30px] py-20 dark:border-[#F54BB4] dark:border-dark">
              <span>
                <svg xmlns="http://www.w3.org/2000/svg" width={60} height={60} viewBox="0 0 60 60" fill="none">
                  <rect width={60} height={60} className="fill-backgroundBody dark:fill-secondary" />
              ...
              <h5 className="mb-2.5 mt-5 lg:text-[35px]">Social Media Content Design</h5>
              <p className="text-base leading-[1.6]">
                Harness cutting-edge AI to enhance automation &amp; user engagement.
              </p>
            </RevealWrapper>
            <RevealWrapper className="flex-1 border border-[#F54BB4] px-[30px] py-20 dark:border-[#F54BB4] dark:border-dark">
              ...
              <h5 className="mb-2.5 mt-5 lg:text-[35px]">Copywriting & Content Strategy</h5>
              <p className="text-base leading-[1.6]">Tailor-made solutions for startups, SMEs, and enterprises.</p>
            </RevealWrapper>
            <RevealWrapper className="flex-1 border border-[#F54BB4] px-[30px] py-20 dark:border-[#F54BB4] dark:border-dark">
              <span>
              ...
              <h5 className="mb-2.5 mt-5 lg:text-[35px]">Digital Marketing Services</h5>
              <p className="text-base leading-[1.6]">Apps built for growth, high performance &amp; security.y</p>
            </RevealWrapper>
          </RevealWrapper>
        </article>
